...
model = YOLO('D:/ChanWooKim/auto_dna/runs/100_Epoch_edit_parameter(10.13)/weights/best.pt').cuda()
print(model.task)
...
input_base_dir = 'D:/ChanWooKim/dataset/test'#Val Data directory
output_base_dir = './Result/100_Epoch_edit_parameter(10.13)'
